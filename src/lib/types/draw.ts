...
export const DRAW_BASE_VOLATILITY = 0.002;
export const DRAW_SLOPE_FACTOR = 1.5;
export const DRAW_PRICE_RANGE_PERCENT = 0.5; // Y range maps to ±50% of starting price
