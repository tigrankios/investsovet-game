  ...
  if (!joined) {
    return (
      <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center p-6">
        ...
        <p className="text-accent-gold mb-8 flex items-center gap-1"><IconCrown size={16} /> Market Maker</p>
  ...
  if (!gameState || gameState.phase === 'lobby') {
    return (
      <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center p-6">
        ...
        <p className="text-accent-gold/70 text-sm mt-2 flex items-center gap-1"><IconCrown size={14} /> Режим: Маркет-Мейкер</p>
